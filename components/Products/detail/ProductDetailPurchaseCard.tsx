      ...
      <CardContent className="space-y-6 p-6 sm:p-8">
        <div className="space-y-3">
          ...
          <p className="text-sm leading-6 text-slate-300">
            Giao dien nay dang dung mock data, nhung cau truc da san sang de thay bang API
            that sau nay.
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <MainButton
            className="border-white/20 text-white hover:border-white/35 hover:bg-white/10 hover:text-white"
            fullWidth
            size="large"
            variant="outline"
          >
